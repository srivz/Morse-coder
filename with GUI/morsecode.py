...
# the credentials needed to connect to the {bolt wifi module, twilio account, mailgun account} in a local variable
        ...
        for j in code:
            ...
            if j == ' ':
                ...
                if j == '-':
                    ...
                    mybolt.analogWrite('0', 240)  # Turns on the buzzer and led and reduces its intensity..
